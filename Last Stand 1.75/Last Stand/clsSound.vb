...
Public Class clsSound
    ...
    Public Sub New(frmToPass As Form, strDirectory As String, intNumberOfSounds As Integer)
        ...
        If IO.File.Exists(strDirectory) Then
            ...
            For intLoop As Integer = 0 To _intNumberOfSounds - 1
                ...
                intIndex = intLoop
                'Open individual
                _frmToPass.Invoke(Sub() intReturn = mciSendString("open " & ControlChars.Quote & strDirectory & ControlChars.Quote &
                                                                  " alias " & _strAlias &
                                  CStr(intIndex), "", 0, 0))
            Next
        Else
    ...
    Public Sub ChangeVolumeWhileSoundIsPlaying()
        ...
        'Set volume
        _frmToPass.Invoke(Sub() intReturn = mciSendString("setaudio " & _strAlias & CStr(_intNumberOfSounds - 1) & " volume to " &
                          CStr(gintSoundVolume), "", 0, 0))
        ...
        Else
            ...
            For intLoop As Integer = 0 To _intNumberOfSounds - 1
                ...
                If Not SoundIsPlaying(intLoop) Then
                    ...
                    intIndex = intLoop
                    'Set volume
                    _frmToPass.Invoke(Sub() intReturn = mciSendString("setaudio " & _strAlias & CStr(intIndex) & " volume to " & CStr(intVolume),
                                      "", 0, 0))
                    'Seek
