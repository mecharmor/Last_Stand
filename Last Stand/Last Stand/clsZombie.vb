...
Public Class clsZombie
    ...
    'Constants
    Private Const intZOMBIE_WALKING_DELAY As Integer = 160
    Private Const intZOMBIE_DYING_DELAY As Integer = 95
    Private Const intZOMBIE_PINNING_DELAY As Integer = 185
    ...
    Public Sub New(frmToPass As Form, intSpawnX As Integer, intSpawnY As Integer, intSpeed As Integer, strThisObjectNameCorrespondingToCharacter As String,
                   audcZombieDeathSounds() As clsSound, udcWaterSplashSound As clsSound, Optional blnImitation As Boolean = False,
    ...
    Public Sub Start(Optional intAnimatingDelay As Integer = intZOMBIE_WALKING_DELAY)
    ...
    Private Sub Animating()
        ...
        Select Case intFrame
            ...
            Case 1 To 4 'Walking, delay here is ZOMBIE_WALKING_DELAY
                'Set frame and picture
                SetFrameAndPicture(intFrame + 1, gabtmZombieWalkMemories(intFrame - 1), gabtmZombieWalkRedMemories(intFrame - 1),
                                   gabtmZombieWalkBlueMemories(intFrame - 1))
            ...
            Case 8 To 11 'Dying, delay here is ZOMBIE_DYING_DELAY
                'Set frame, frame death, and picture
                SetFrameAndDeathPicture(intFrame + 1, intFrame - 7)
    ...
    Public Sub Dying()
        ...
        'Change interval
        ChangeInterval(intZOMBIE_DYING_DELAY)

        'Play zombie death sound
        _audcZombieDeathSounds(rndNumber.Next(0, 2)).PlaySound(gintSoundVolume)
    ...
    Public Sub Pin()
        ...
        'Change interval
        ChangeInterval(intZOMBIE_PINNING_DELAY)
